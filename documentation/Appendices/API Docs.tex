...
\begin{minted}{bash}
 ...
 server: uvicorn 
\end{minted}
\subsection{/collections/\{collection\}}
Response body:
\begin{minted}{json}
{
  "name": "castles",
...
\end{minted}
\newpage
\subsection{/collections/\{collection\}/items}
...
\begin{minted}{bash}
 ...
 server: uvicorn 
\end{minted}
\subsection{/collections/\{collection\}/\{feature\_id\}}
Response body:
\begin{minted}{json}
{
  "type": "Feature",
...
\end{minted}
\newpage
\subsection{/tiles/\{collection\}/\{zoom\}/\{x\}/\{y\}/\{a\}/\{b\}.geojson}
\begin{minted}{json}
{
  "type": "FeatureCollection",
  "features": [
