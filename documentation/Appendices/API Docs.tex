...
\end{minted}
\newpage
\subsection{api/collections/\{collection\}/items}
...
\begin{minted}{bash}
 ...
 server: uvicorn 
\end{minted}
\subsection{api/collections/\{collection\}/\{feature\_id\}}
Response body:
\begin{minted}{json}
{
  "type": "Feature",
...
\subsection{api/tiles/\{collection\}/\{zoom\}/\{x\}/\{y\}.png}
Response body:\\
\begin{figure}[H]
	\begin{center}
...
\end{minted}
\newpage
\subsection{api/tiles/\{collection\}/\{zoom\}/\{x\}/\{y\}/\{a\}/\{b\}.geojson}
\begin{minted}{json}
{
  "type": "FeatureCollection",
  "features": [
